...
const useSchema = new mongoose_1.default.Schema({
    ...
    my_follow: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'user', }],
    follower: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'user', }],
    block_account: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'user', }],
    post_saved: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'blog' }],
    password: {
        type: String,
...
exports.default = mongoose_1.default.model('user', useSchema);
