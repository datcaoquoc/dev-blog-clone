...
import { ObjectFromGetApiBlogByID } from "../../../utils/TypeScript";
      ...
      <WraperPostInfomationPostdetail>
        <WraperUserInfomation>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <TimeCreate style={{ marginLeft: "10px", fontSize: "13px" }}>
              Đăng {moment(props?.blog?.createdAt).fromNow()}
            </TimeCreate>
          </div>
        </WraperUserInfomation>
